...
import { PharmaciesAuditedDetailReportCard } from "@/components/mr/presentation/PresentationReportSections";
import { Button } from "@/components/ui/button";

export default async function PharmaciesAuditedDetailReportPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <PharmaciesAuditedDetailReportCard auditedPharmaciesDetail={data.auditedPharmaciesDetail} />
    </div>
  );
}
