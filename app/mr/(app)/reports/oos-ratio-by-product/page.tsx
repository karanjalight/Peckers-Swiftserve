...
import { OosRatioByProductReportCard } from "@/components/mr/presentation/PresentationReportSections";
import { Button } from "@/components/ui/button";

export default async function OosRatioByProductReportPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <OosRatioByProductReportCard oosRatioPerProduct={data.oosRatioPerProduct} />
    </div>
  );
}
