...
import { PharmacyMarketShareReportCard } from "@/components/mr/presentation/PresentationReportSections";
import { Button } from "@/components/ui/button";

export default async function PharmacyMarketShareReportPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <PharmacyMarketShareReportCard pharmacyMarketShareEstimate={data.pharmacyMarketShareEstimate} />
    </div>
  );
}
