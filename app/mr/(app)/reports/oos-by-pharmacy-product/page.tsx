...
import { OosByPharmacyProductReportCard } from "@/components/mr/presentation/PresentationReportSections";
import { Button } from "@/components/ui/button";

export default async function OosByPharmacyProductReportPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <OosByPharmacyProductReportCard outOfStockDetail={data.outOfStockDetail} />
    </div>
  );
}
