...
import { TopPrescribersByProductReportCard } from "@/components/mr/presentation/PresentationReportSections";
import { Button } from "@/components/ui/button";

export default async function TopPrescribersByProductReportPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <TopPrescribersByProductReportCard topPrescribersPerProduct={data.topPrescribersPerProduct} />
    </div>
  );
}
