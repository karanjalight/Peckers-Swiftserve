...
export default function ContactHero({
  ...
  highlight,
  breadcrumbs = [],
  background = "https://sashleynannies.co.ke/wp-content/uploads/2023/01/sashley-nannies-11-1024x683.jpeg",
}: ProjectHeroProps) {
  return (
    <section
    className="relative flex lg:h-[53vh] h-[20%] flex-col md:flex-row items-center  lg:justify-between px-6 sm:px-10 md:px-32 py-8 md:py-20 bg-cover md:bg-top bg-no-repeat bg-bottom text-white"
