    ...
    >
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-20 py-3">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link
            href="/login"
            className="relative font-normal inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#b38f62] text-white hover:bg-[#02273f] transition-all duration-300"
          >
            Login →
          </Link>
          ...
          <div className="fixed top-0 left-0 right-0 bottom-0 bg-white z-50 lg:hidden overflow-y-auto">
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 space-y-2">
                <Button className="w-full text-white bg-[#b38f62] hover:bg-[#02273f] rounded-none">
                  Get Started →
                </Button>
                <Button className="w-full text-white bg-[#b38f62] hover:bg-[#02273f] rounded-none">
                  Login →
