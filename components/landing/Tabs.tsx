...
export default function ServicesShowcase() {
  ...
  const cards: Service[] = [
    
    {
      ...
      color: "House Hold",
      icon: NannyIcon,
      image: "/nannybabby.jpeg",
      gradient: "from-gray-700/30 to-gray-900/50",
      slug: "services/emergency-nanny",
    },
    {
      id: 2,
    ...
    {
      id: 7,
      title: "Guard Dogs with handlers",
      color: "House Hold",
      icon: SecurityIcon,
      image: "/security3.jpeg",
      gradient: "from-gray-700/30 to-gray-900/50",
      slug: "services/hire-security",
    }, {
      id: 8,
      title: "Home Based Care",
      color: "House Hold",
      icon: SecurityIcon,
      image: "/homecare1.jpeg",
      gradient: "from-gray-700/30 to-gray-900/50",
      slug: "services/emergency-nanny",
    },
    {
