        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="ml-auto text-sm underline-offset-2 hover:underline disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <FieldSeparator className="*:data-[slot=field-separator-content]:bg-card hidden">
                Or continue with
              </FieldSeparator>

              <Field className="grid grid-cols-3 gap-4 hidden">
